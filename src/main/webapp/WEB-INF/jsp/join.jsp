...
<form method="post" action="/simpleboard/join">

	<div><span>아이디:</span><span><input name="userid" type="text" value="${formUserId }"/></span> </div>
	<div><span>이메일:</span><span><input name="email" type="text"  value="${formEmail }" /></span> </div>
